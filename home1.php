...
<ul>
  ...
  <li><a href="#con">Contact</a></li>
          <li style="float:right"><a href="home.php"><span class="glyphicon glyphicon-log-in"></span> Log out</a></li>

      <li style="float:right"><a><span class="glyphicon glyphicon-heart"></span> Welcome!</a></li>
...
<div id="container">
  ...
  <div class="center2"><form action="app1.php" method="POST"><button class="button" style="vertical-align:middle" type="submit" name="book_now"><span>Book now</span></button></form></div>
</div>
...
<div class="container-fluid text-center">
  ...
  <div class="row">
    ...
    <a href="mudras.html"><h4>MUDRAS</h4></a>
    </div>
  </div>
    </div>
  </div>
...
<div class="containerr1-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 9888844411</p>
      <p><span class="glyphicon glyphicon-envelope"></span> thehealthcare@gmail.com</p>
    </div>
    <div class="col-sm-7">
      <div class="row">
...
<footer class="text-center">
  ...
  <p>Health & Fitness Website Made By 115a1014,115a1015,115a1016</a></p> 
</footer>
